...
RCT_EXPORT_VIEW_PROPERTY(controlCenter, NSDictionary);
...
RCT_EXPORT_VIEW_PROPERTY(onRemotePrevious, RCTDirectEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onRemoteNext, RCTDirectEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onRemotePlay, RCTDirectEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onRemotePause, RCTDirectEventBlock);
