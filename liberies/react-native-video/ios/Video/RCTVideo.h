...
@property (nonatomic, copy) RCTDirectEventBlock onRemoteNext;
@property (nonatomic, copy) RCTDirectEventBlock onRemotePrevious;
@property (nonatomic, copy) RCTDirectEventBlock onRemotePlay;
@property (nonatomic, copy) RCTDirectEventBlock onRemotePause;
