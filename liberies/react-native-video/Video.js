...
export default class Video extends Component {
  ...
  _onRemotePrevious = (event) => {
    if (this.props.onRemotePrevious) {
      this.props.onRemotePrevious();
    }
  };
  _onRemoteNext = (event) => {
    if (this.props.onRemoteNext) {
      this.props.onRemoteNext();
    }
  };
  _onRemotePlay = (event) => {
    if (this.props.onRemotePlay) {
      this.props.onRemotePlay();
    }
  };
  _onRemotePause = (event) => {
    if (this.props.onRemotePause) {
      this.props.onRemotePause();
    }
  };
  render() {
    ...
    Object.assign(nativeProps, {
      ...
      onRemotePrevious: this._onRemotePrevious,
      onRemoteNext: this._onRemoteNext,
      onRemotePlay: this._onRemotePlay,
      onRemotePause: this._onRemotePause,
    });
...
Video.propTypes = {
  ...
  onRemotePrevious: PropTypes.func,
  onRemoteNext: PropTypes.func,
  onRemotePlay: PropTypes.func,
  onRemotePause: PropTypes.func,
